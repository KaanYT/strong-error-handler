 ...
 *
 * @param {Object} options  (debug : Boolean), (log : Boolean), (formatter : String) ; Function in String, Inputs, req,res,data
 * @returns {Function}
 */
exports = module.exports = function createStrongErrorHandler(options) {
  ...
  var formatData = options.formatter != null ? Function("req", "res", "data", options.formatter) : Function("req", "res", "data", "return;");
